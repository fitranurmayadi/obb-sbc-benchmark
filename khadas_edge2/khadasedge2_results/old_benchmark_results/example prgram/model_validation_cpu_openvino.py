...
models = [
    ...
    ("yolo11m-obb-320_openvino_model", 320),
    ("yolo11n-obb-640_openvino_model", 640),
    ("yolo11s-obb-640_openvino_model", 640),
    ("yolo11m-obb-640_openvino_model", 640),
    ("yolo11n-obb-1280_openvino_model", 1280),
    ("yolo11s-obb-1280_openvino_model", 1280),
    ("yolo11m-obb-1280_openvino_model", 1280),
]
...
conf = 0.25
iou = 0.6
device = '0'  # Bisa ganti ke "cpu" atau "cuda:0"

# Folder hasil validasi
os.makedirs("val_results", exist_ok=True)
log_file = f"val_results/val_summary_cpu_openvino_rk3588_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
