...
models = [
    ...
    ("yolo11s-obb-320.onnx", 320),
    ("yolo11m-obb-320.onnx", 320),
    ("yolo11n-obb-640.onnx", 640),
    ("yolo11s-obb-640.onnx", 640),
    ("yolo11m-obb-640.onnx", 640),
    ("yolo11n-obb-1280.onnx", 1280),
    ("yolo11s-obb-1280.onnx", 1280),
    ("yolo11m-obb-1280.onnx", 1280),
]
...
log_file = f"validation_results/validation_rk3588_cpu_onnx_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
