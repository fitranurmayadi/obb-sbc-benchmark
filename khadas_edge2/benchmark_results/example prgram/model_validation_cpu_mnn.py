...
models = [
    ...
    ("yolo11m-obb-320.mnn", 320),
    ("yolo11n-obb-640.mnn", 640),    
    ("yolo11s-obb-640.mnn", 640),
    ("yolo11m-obb-640.mnn", 640),
    ("yolo11n-obb-1280.mnn", 1280),
    ("yolo11s-obb-1280.mnn", 1280),
    ("yolo11m-obb-1280.mnn", 1280),
]
...
log_file = f"validation_results/validation_rk3588_cpu_mnn_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
